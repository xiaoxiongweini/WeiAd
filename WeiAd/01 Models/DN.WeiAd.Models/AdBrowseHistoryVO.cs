...
namespace DN.WeiAd.Models
{
    ...
    /// 用户登录日志
    /// </summary>
    public partial class AdBrowseHistoryVO: IModel
    {
        public AdBrowseHistoryVO() { }

        public AdBrowseHistoryVO(IDataReader row)
        {
        ...
        public AdBrowseHistoryVO(DataRow row)
        {
          Id = ConvertHelper.GetInt(row["Id"]);
          Url = ConvertHelper.GetString(row["Url"]);
          ClientIp = ConvertHelper.GetString(row["ClientIp"]);
       ...
       public string OsName { get; set; }
        ...
        public object Clone()
        {
            AdBrowseHistoryVO obj = new AdBrowseHistoryVO();
