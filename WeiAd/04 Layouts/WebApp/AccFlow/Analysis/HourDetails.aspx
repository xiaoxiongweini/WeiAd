<%@ Page Title="" Language="C#" MasterPageFile="~/AccFlow/Web.Master" AutoEventWireup="true" CodeBehind="HourDetails.aspx.cs" Inherits="WebApp.AccFlow.Analysis.HourDetails" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="miniContent" runat="server">
    <asp:HiddenField runat="server" ID="hidAdUserId" />
    <!-- Main content -->
