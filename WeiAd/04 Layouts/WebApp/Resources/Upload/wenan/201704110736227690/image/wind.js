...
; (function (win, undefined) {
    ...
    if (isAsync) {
        api.load = function () {
            ///<summary>
            /// INFO: use cases
            ///    head.load("js/file.js","js/file.js", callBack)
            ///    head.load({ label1: "js/file.js" }, { label2: "js/file.js" }, callBack)
            ///</summary> 
            var args      = arguments,
    ...
    api.test = function (test, success, failure, callback) {
        ...
        ///    head.test(condition, "js/fileOk.js", null       , callback);        
        ///    head.test(condition, "js/fileOk.js", "file.NOk" , callback);
        ///    head.test(condition, "js/fileOk.js", ["file.NOk", "file.NOk"], callback);
        ///    head.test({
        ///               test    : condition,
        ///               success : [{ label1: "js/file1Ok.js"  }, { label2: "file2Ok.js" }],
        ///               failure : [{ label1: "file1NOk.js" }, { label2: "file2NOk.js" }],
        ///               callback: callback
        ///    );  
        ///    head.test({
        ///               test    : condition,
        ///               success : ["js/file1Ok.js" , "file2Ok.js"],
    ...
    api.ready = function (key, callback) {
        ...
        ///    head.ready("js/file.js", callBack);
