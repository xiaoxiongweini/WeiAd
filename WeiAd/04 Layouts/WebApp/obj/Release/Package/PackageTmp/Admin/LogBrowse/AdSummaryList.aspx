<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true" CodeBehind="AdSummaryList.aspx.cs" Inherits="WebApp.Admin.LogBrowse.AdSummaryList" %>
                                ...
                                <asp:Repeater runat="server" ID="rptTable">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("ipcount") %></td>
                                            <th>
                                                <a class="btn btn-info btn-xs" target="_blank"  href="AdDaySummaryList.aspx?adid=<%#Eval("AdId") %>">查看天详情</a>
                                            </th>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
