<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true" CodeBehind="ChangedTemp.aspx.cs" Inherits="WebApp.Admin.Ads.ChangedTemp" %>
            ...
            <div class="box-body ">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <asp:Button runat="server" ID="btnMiddle" CssClass="btn btn-info form-control" Text="生成中间页" OnClick="btnMiddle_Click" />
                        </div>
                         <div class="col-xs-2">
