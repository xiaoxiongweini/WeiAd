<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true" CodeBehind="CusList.aspx.cs" Inherits="WebApp.Admin.Cus.CusList" %>
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <asp:DropDownList runat="server" ID="ddlDel" CssClass="form-control">
                        ...
                        <asp:Repeater runat="server" ID="rptTables">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="CusList.aspx?id=<%#Eval("Id")%>&isdel=1" onclick="return confirm('确认删除吗？');" class="btn btn-info btn-xs">删除</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="6">【<%#Eval("AdId") %>】- <%#Eval("AdUrl") %>
                                        <br />
                                        <%#Eval("ClientIp") %>
                                    </td>
                                </tr>
