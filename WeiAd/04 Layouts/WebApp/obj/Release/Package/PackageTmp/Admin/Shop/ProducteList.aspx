<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true" CodeBehind="ProducteList.aspx.cs" Inherits="WebApp.Admin.Shop.ProducteList" %>
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <a href="ProdcuteEdit.aspx" class="btn btn-info">添加产品</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <asp:Repeater runat="server" ID="rptTables">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <%#DN.WeiAd.Business.AccountInfoBLL.Instance.GetNickNameByUserId( Eval("CreateUserId")) %>
                                    </td>
                                    <td>
                                        <%#Eval("Name") %>
                                    </td>
                                    ...
                                    <td>
                                        <a href="ProdcuteEdit.aspx?id=<%#Eval("Id")%>" class="btn btn-info btn-xs">编辑</a>
                                        <a href="ProducteList.aspx?id=<%#Eval("Id")%>&isdel=1" onclick="confirm('确认删除吗？');" class="btn btn-danger btn-xs">删除</a>    
                                        <a href="/Admin/Ads/AdPageEdit.aspx?id=<%#Eval("AdId")%>" target="_blank" class="btn btn-default btn-xs">编辑文案</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="5">
                                     <%#DN.WeiAd.Business.AccountInfoBLL.Instance.GetNickNameByAdId(Eval("AdId")) %>  --  <%#Eval("AdId") %> --
