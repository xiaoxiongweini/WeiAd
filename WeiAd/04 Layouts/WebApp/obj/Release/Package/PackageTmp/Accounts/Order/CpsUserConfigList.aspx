<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="CpsUserConfigList.aspx.cs" Inherits="WebApp.Accounts.Order.CpsUserConfigList" %>
                        ...
                        <asp:Repeater runat="server" ID="rptTables">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td> <%#Eval("CpsUserId") %>-
                                        <%#DN.WeiAd.Business.AccountInfoBLL.Instance.GetNickNameByUserId( Eval("CpsUserId")) %>
                                    </td>
                                    <td>
                                        <%#Eval("CreateDate") %>
                                    </td>
