<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="AdAnalysis.aspx.cs" Inherits="WebApp.Accounts.LogBrowse.AdAnalysis" %>
                                ...
                                <asp:Repeater runat="server" ID="rptTable">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("ipcount") %></td>
                                            <th>
                                                <a class="btn btn-info btn-xs" target="_blank" href="HourAnalysis.aspx?time=<%#Eval("Time") %>&adid=<%#Eval("AdId") %>">分时段分析</a>
                                            </th>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
