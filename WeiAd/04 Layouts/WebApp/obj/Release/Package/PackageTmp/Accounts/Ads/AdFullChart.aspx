<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="AdFullChart.aspx.cs" Inherits="WebApp.Accounts.Ads.AdFullChart" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="miniContent" runat="server">
    ...
    <asp:HiddenField runat="server" ID="hidTitle" />
    <!-- Main content -->
