<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="UrlList.aspx.cs" Inherits="WebApp.Accounts.Pages.UrlList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="miniContent" runat="server">
    <asp:HiddenField runat="server" ID="hidAdId" Value="" />
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <a class="btn btn-info" href="AdPageEdit.aspx">添加URL地址</a>
                            </div>
                        </div>
                        <br />
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="opclass " rowspan="2">
                                                ...
                                                <a class="btn btn-info btn-xs" href="ChangAdHtml.aspx?adid=<%#Eval("Id") %>">生成文件</a>
