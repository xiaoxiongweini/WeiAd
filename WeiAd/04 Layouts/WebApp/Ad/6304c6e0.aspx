...
<head runat="server">
    ...
    <script type="text/javascript" src="/Assets/Scripts/adview.js?v=v1.0.4"></script>
</head>
            ...
            <div class="rich_media_inner">
                <div id="page-content">
                    <div id="img-content" class="rich_media_area_primary">
                        ...
                        <h2 class="rich_media_title"  id="articletitle">

                        </h2>
                        <div class="rich_media_content " id="js_content">
                            <div id="js_articlecontent"><asp:Literal runat="server" ID="ltContent"></asp:Literal></div>
                        ...
                        <div class="rich_media_area_extra">
                            ...
                            <div id="js_iframetest" style="display: none;">
                                <span id="spanidarticle"><asp:Literal runat="server" ID="ltUserCode"></asp:Literal></span>
                            </div>
                        </div>
                    </div>
                </div>
