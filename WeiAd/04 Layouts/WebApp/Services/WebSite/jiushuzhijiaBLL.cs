...
namespace WebApp.Services.WebSite
{
    public class jiushuzhijiaBLL
    {
        ...
        {
            string url = "http://ads.jiushuzhijia.cn/index.php/Public/checkLogin";
            string rurl = "http://ads.jiushuzhijia.cn/index.php/Public/login/";
            string purl = "serviceIp=192.168.3.44&username=9shu_smomo&password=123456";
            string html = PostLogin(url, rurl, purl);
            string count = "0";
            string shtml = "";
            if (html.IndexOf("/index.php/Public/index/") != -1)
            {
                shtml = post("http://ads.jiushuzhijia.cn/index.php/Index/logs2");
        ...
        static string post(string postUrl)
        {
            ...
            try
            {
                ...
                request.Referer = "http://ads.jiushuzhijia.cn/index.php/Public/checkLogin";
                ...
                cc.Add(new System.Uri("http://ads.jiushuzhijia.cn"), new Cookie("PHPSESSID", "3opns768dchpd1dcvb4sicr5o4"));
