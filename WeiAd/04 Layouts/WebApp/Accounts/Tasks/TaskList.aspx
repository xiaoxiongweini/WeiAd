<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="TaskList.aspx.cs" Inherits="WebApp.Accounts.Tasks.TaskList" %>
                                ...
                                <asp:Repeater runat="server" ID="rptTable">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="button" class="btn btn-info btn-xs"  value="关闭"></input>                                                
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
