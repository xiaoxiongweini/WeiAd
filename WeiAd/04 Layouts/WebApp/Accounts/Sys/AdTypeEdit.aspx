<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="AdTypeEdit.aspx.cs" Inherits="WebApp.Accounts.Sys.AdTypeEdit" %>
            ...
            <div class="box-body ">
                <div class="row">
                    <div class="form-group">
                        <label class="col-xs-offset-1 col-xs-2">分类名称</label>
                        <div class="col-xs-6">
                 ...
                 <div class="row">
                    <div class="form-group">
                        <label class="col-xs-offset-1 col-xs-2">分类描述</label>
                        <div class="col-xs-6">
