...
namespace WebApp.Accounts.Article
{
    public partial class ArticleEdit : BasePage
    {
        ...
        private void BindPage()
        {
            ...
            {
                var info = ArticleInfoBLL.Instance.GetSingle(new ArticleInfoPara() { Id = int.Parse(hidId.Value), CreateUserId = Account.UserId });
                if (info != null)
                {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/Accounts/Article/ArticleList.aspx");
            }
            else
            {
