<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="QcodeList.aspx.cs" Inherits="WebApp.Accounts.Pages.QcodeList" %>
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-3">
                                <asp:Button runat="server" CssClass="btn btn-info form-control" ID="btnReface" Text="刷新二维码缓存" OnClick="btnReface_Click" />
                            </div>
                            <div class="col-xs-2">
                                <a href="QcodeEdit.aspx?adid=<%=hidAdId.Value %>" class="btn btn-info form-control">添加二维码</a>
                            </div>
                        </div>
                        <br />
                                ...
                                <asp:Repeater runat="server" ID="rptTable">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-xs" href="QcodeEdit.aspx?adid=<%=hidAdId.Value %>&id=<%#Eval("Id") %>">修改</a>
