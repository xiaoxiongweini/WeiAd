...
{
    public partial class UserFinanceList : BasePage
    {
        ...
        {
            UserFinanceHistoryPara cip = new UserFinanceHistoryPara();
            cip.PageIndex = pageIndex - 1;
            cip.PageSize = 10;
            cip.UserId = Account.UserId;
            cip.OrderBy = " id desc ";

            var list = UserFinanceHistoryBLL.Instance.GetModels(ref cip);
