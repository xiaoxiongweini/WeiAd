<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="HourAnalysis.aspx.cs" Inherits="WebApp.Accounts.Charts.HourAnalysis" %>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><asp:Literal runat="server" ID="ltStime" Text=""></asp:Literal>_<asp:Literal runat="server" ID="ltAdTitle"></asp:Literal> </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
