<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Web.Master" AutoEventWireup="true" CodeBehind="HourAnalysis.aspx.cs" Inherits="WebApp.Accounts.Charts.His.HourAnalysis" %>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">分时段分析 (<asp:Literal runat="server" ID="ltStime" Text=""></asp:Literal>至<asp:Literal runat="server" ID="ltEtime" Text=""></asp:Literal>) </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">分时段趋势</div>
