<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true" CodeBehind="AdAnalysis.aspx.cs" Inherits="WebApp.Admin.LogBrowse.AdAnalysis" %>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <asp:DropDownList runat="server" ID="ddlAdUserId" CssClass="form-control"></asp:DropDownList>
                            </div>
                            <div class="col-xs-1">
