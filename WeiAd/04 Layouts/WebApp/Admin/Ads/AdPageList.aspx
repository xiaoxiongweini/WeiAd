<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true" CodeBehind="AdPageList.aspx.cs" Inherits="WebApp.Admin.Ads.AdPageList" %>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td rowspan="2">
                                                ...
                                                <a class="btn btn-info btn-xs" href="AdUserFlowEdit.aspx?adid=<%#Eval("Id") %>">指定工作室</a>
                                                <br />
                                                <a class="btn btn-info btn-xs" href="DayAnalysis.aspx?adid=<%#Eval("Id") %>">流量总览</a>
                                                <a class="btn btn-info btn-xs" href="ChangedTemp.aspx?adid=<%#Eval("Id") %>">修改模版</a>
                                                <a class="btn btn-info btn-xs" href="QcodeList.aspx?adid=<%#Eval("Id") %>">查看二维码</a>
                                                <br />
                                                <input type="button" onclick="onshowcopy('<%#Eval("Id") %>    ');" value="复制" class="btn btn-info btn-xs" />
                                                <a class="btn btn-info btn-xs" href="AdPageList.aspx?id=<%#Eval("Id") %>&isdel=1">删除</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="12">标题：<a target="_blank" href="/AdView.aspx?adid=<%#Eval("Id") %>">
                                                <%#Eval("Title") %></a>
                                                <br />
                                                <p style="display:none;">
                                                预览页：<a target="_blank" href="/AdView.aspx?adid=<%#Eval("Id") %>">
                                                ...
                                                投放页： <a target="_blank" href="<%#DN.WeiAd.Business.AdPageInfoBLL.Instance.GetMiddlePage(Eval("MiddlePage")) %>">
                                                    <%#DN.WeiAd.Business.AdPageInfoBLL.Instance.GetMiddlePage(Eval("MiddlePage"))  %></a></p>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
