<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true" CodeBehind="BrowseDayList.aspx.cs" Inherits="WebApp.Admin.Finances.BrowseDayList" %>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <asp:Button runat="server" ID="btnUpdateClick" CssClass="btn btn-info form-control" Text="转换点击信息" OnClick="btnUpdateClick_Click" />
                            </div>
                        </div>
                        <br />
