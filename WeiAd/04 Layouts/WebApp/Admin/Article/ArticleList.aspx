<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true" CodeBehind="ArticleList.aspx.cs" Inherits="WebApp.Admin.Article.ArticleList" %>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info btn-xs" href="ArticleList.aspx?id=<%#Eval("Id")%>&tid=<%#Eval("ChannelId")%>&top=1">顶/消</a>
                                        <a class="btn btn-info btn-xs" href="ArticleList.aspx?id=<%#Eval("Id")%>&tid=<%#Eval("ChannelId")%>&hot=1">热/消</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
