  ...
  /// </summary>
    public class douzhuanDfBLL
    {
        ...
        public static string GetCount(string xpath = "")
        {
            ...
            if (html.Length > 10)
            {
                shtml = GetDate("http://guanggao-pv.uicp.cn/dfcx/commonQuery/dtquery.do?sqlname=SQL_Zq_Advvist_Today_Stat.advlist");
                ...
                shtml = GetDate("http://guanggao-pv.uicp.cn/dfcx/commonQuery/dtquery.do?sqlname=SQL_Zq_Advvist_Today_Stat.advhistorylist");
        ...
        static string GetDate(string postUrl)
        {
            ...
            try
            {
                ...
                cc.Add(new System.Uri("http://guanggao-pv.uicp.cn"), new Cookie("JSESSIONID", "38837539686B1D31F3D8BD0AFA67A972"));
