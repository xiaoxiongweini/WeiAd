...
namespace DN.WeiAd.Business
{
    ...
    /// 历史数据分析
    /// </summary>
    public class AnalysisFlowHisBLL
    {
        #region 实例

        static AnalysisFlowHisBLL m_proxy = null;

        static ChartInterface acc = null;
        public static AnalysisFlowHisBLL Instance
        {
            get
            {
                if (m_proxy == null)
                {
                    ...
                    m_proxy = new AnalysisFlowHisBLL();
                }
...
group by left(convert(varchar(10), CreateDate, 108), 2)
        ...
        /// <param name="userid"></param>
        /// <returns></returns>
        public EChartInfoJson GetAdBrowseHour(DataTable table)
        {
            //时间数据
